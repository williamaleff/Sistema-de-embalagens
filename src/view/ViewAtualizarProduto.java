 ...
 */
public class ViewAtualizarProduto extends javax.swing.JFrame {

    /**
     * Creates new form ViewAtualizarProduto
     */
    public ViewAtualizarProduto() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ViewAtualizarProduto.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ViewAtualizarProduto().setVisible(true);
            }
        });
    }
